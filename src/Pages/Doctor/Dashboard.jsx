...
const StatCard = ({ title, value, icon }) => {
  return (
    <motion.div 
      ...
      className="bg-white rounded-xl shadow-sm hover:shadow-md transition-all duration-300 p-5 flex items-center"
    >
      <div className="p-3 rounded-full mr-4 bg-gray-50">
        {icon}
      </div>
      <div>
